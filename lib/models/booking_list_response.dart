...
class BookingListResponse {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (paymentBreakdown != null) {
      data['payment_breakdown'] = paymentBreakdown!.toJson();
    }
    return data;
  }
}
...
class PaymentBreakdown {
  ...
  Map<String, dynamic> toJson() {
    ...
    data['admin_earned'] = adminEarned;
    data['handyman_earned'] = handymanEarned;
    data['provider_earned'] = providerEarned;
    data['tax'] = tax;
...
class BookingData {
  ...
  bool get isProviderAndHandymanSame =>
      handyman
          .validate()
          .isNotEmpty ? handyman
          .validate()
          .first
          .handymanId
          .validate() == providerId.validate() : false;
